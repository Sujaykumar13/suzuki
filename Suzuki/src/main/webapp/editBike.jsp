  ...
  <%@ page isELIgnored="false" %>
    ...
    <style>
        ...
        <div class="d-flex justify-content-between align-items-center px-3 py-2">
          ...
          <div>
            ...
            <button type="button" class="btn btn-info btn-sm mr-2"><a href="viewBike?emailId=${email}"
                style="color: white;" role="button">View Bike</a></button>
     ...
     <div class="min-vh-100 d-flex justify-content-center align-items-center" style="background: linear-gradient(to right, #667eea, #764ba2);">
       ...
       <form action="updateBikeData?emailId=${email}" method="post" onsubmit="form()" enctype="multipart/form-data"
         ...
         <div class="card shadow-lg p-4 bg-light rounded">
           ...
           <h2 class="text-center text-primary mb-4">Edit Bike Details</h2>

           <!-- Carousel for existing images -->
           <div id="bikeImagesCarousel" class="carousel slide mb-4" data-ride="carousel">
             <div class="carousel-inner text-center">
               <div class="carousel-item active">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?frontImageFileName=${dto.frontImageFileName}" alt="Front view">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?leftImageFileName=${dto.leftImageFileName}" alt="Left view">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?backImageFileName=${dto.backImageFileName}" alt="Back view">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?rightImageFileName=${dto.rightImageFileName}" alt="Right view">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?topImageFileName=${dto.topImageFileName}" alt="Top view">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto img-fluid" style="max-height: 300px;"
                   src="bikeImage?d3ImageFileName=${dto.d3ImageFileName}" alt="3D view">
               </div>
             </div>
           </div>
           ...
           <div class="form-row mb-3">
             <div class="form-group col-md-6">
               ...
               <input type="text" class="form-control" name="bikeName" id="bName" value="${dto.bikeName}" onchange="bNameValidation()" readonly required>
               <small id="bikeError" class="text-danger"></small>
             </div>
             <div class="form-group col-md-6">
               <label>Model</label>
               <input type="text" class="form-control" name="bikeModel" id="model" value="${dto.bikeModel}" onchange="modelValidation()" required>
               <small id="modelError" class="text-danger"></small>
             </div>
           </div>

           <!-- Price & Engine Capacity -->
           <div class="form-row mb-3">
             <div class="form-group col-md-6">
               <label>Price</label>
               <input type="number" class="form-control" name="price" id="bikePrice" value="${dto.price}" onchange="priceValidation()" required>
               <small id="priceError" class="text-danger"></small>
             </div>
             <div class="form-group col-md-6">
               <label>Engine Capacity</label>
               <input type="text" class="form-control" name="engineCapacity" id="engine" value="${dto.engineCapacity}" onchange="engineValidation()" required>
           ...
           <div class="form-row mb-3">
             <div class="form-group col-md-6">
               <label>Mileage</label>
               <input type="text" class="form-control" name="milege" id="bikeMilege" value="${dto.milege}" onchange="milegeValidation()" required>
               <small id="milegeError" class="text-danger"></small>
             </div>
             <div class="form-group col-md-6">
               <label>Fuel Capacity</label>
               <input type="text" class="form-control" name="fuelCapacity" id="fuel" value="${dto.fuelCapacity}" onchange="fuelValidation()" required>
               <small id="fuelError" class="text-danger"></small>
             </div>
           </div>

           <!-- Image upload inputs in pairs -->
           <div class="form-row mb-3">
             <div class="form-group col-md-6">
           ...
           <div class="form-group text-center">
             ...
             <a href="viewBike?bikeName=${dto.bikeName}&emailId=${email}" class="btn btn-secondary px-4 ml-2">Back</a>
           </div>
...
function rightValidation() {
  ...
  button.removeAttribute("disabled");
        ...
        let originalModel = document.getElementById("model").value;
       ...
       function form(event) {
         var brName = document.getElementById("bName").value.trim();
         var models = document.getElementById("model").value.trim();
         var price = document.getElementById("bikePrice").value.trim();
         var enginecap = document.getElementById("engine").value.trim();
         var mileage = document.getElementById("bikeMilege").value.trim();
         var fuelcap = document.getElementById("fuel").value.trim();
         var button = document.getElementById("button");

         if (
           brName !== "" && brName.length >= 3 && brName.length <= 30 &&
           models !== "" && models.length >= 3 && models.length <= 30 &&
           price !== "" && !isNaN(price) &&
           enginecap !== "" && enginecap.length >= 3 && enginecap.length <= 30 &&
           mileage !== "" && mileage.length >= 2 && mileage.length <= 30 &&
           fuelcap !== "" && fuelcap.length >= 2 && fuelcap.length <= 30
         ) {
